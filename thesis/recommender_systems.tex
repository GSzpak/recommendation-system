...
lala
\section{Wyniki}
Wyniki w zale¿no¶ci od postaci funkcji podobieñstwa $s_{users}$ prezentuje tabela
\ref{t:exp_users}.
...
\hfill \\
Wyniki w zale¿no¶ci od postaci funkcji podobieñstwa $s_{items}$ prezentuje tabela
\ref{t:exp_items}.
