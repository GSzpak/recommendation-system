...
znacznie poprawi³o jako¶æ predykcji - przyk³adowo, ¶redni bezwzglêdny b³±d dla podej¶cia opartego na
przedmiotach zmala³ o ponad 10\% (z 0.803 do 0.715) w stosunku do predyktora bazowego opisanego w
rozdziale \ref{r:experiment}. Nie widaæ natomiast wyra¼nej ró¿nicy miêdzy
tymi dwoma sposobami normalizacji. Zaskakuj± s³abe wyniki otrzymane przy u¿yciu ¶redniej wa¿onej - u¿ycie jej poprawi³o wynik tylko nieznacznie (w przypadku u¿ytkowników)
